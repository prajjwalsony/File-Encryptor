...
operate function - it take arguments as read and write file descriptor, key and
and wheather to encrypt or decrypt. It write the encrypted/decrpted data to
target or write file.
*/
...
int operate(FILE *readFile, FILE *writeFile, unsigned int key, int encrypt_decrypt){ 
...
int main(int argn, char *args[]){
    ...
    if(originalKey==-1){
        printf("Invalid FIle Name OR Not able to open!!");
        printf("\nPress Enter to exit!!!");
