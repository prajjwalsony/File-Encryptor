...
FILE DESCRIPTION:
AES.h contains the round functions, encryption and decryption function.
these two functions take arguments as 32 bit data buffer to encrypt and round
keys and returned encrypted/decrypted 32 bit data buffer
*/
