...
// input 8 bit, key 6 bit
short int DES_encrypt(int input, int key1, int key2){
    short int l, r, a;
    //extract left-right
    l = input >> 4;
    r = input & 15;
    // pass right to functino and xor with left
    l = l^func(r, key1);
    // swap left-right
    a = l;
    l = r;
...
short int DES_decrypt(short int input, short int key1, short int key2){
    short int l, r, a;
    //extract left-right
    l = input >> 4;
    r = input & 15;
    // pass right to functin and xor with left
    l = l^func(r, key2);
    // swap left-right
    a = l;
    l = r;
